...
<link rel="stylesheet" href="<c:url value='/${siteName}/js/lib/zTree/zTreeStyle.css' />" type="text/css">
<script type="text/javascript" src="<c:url value='/${siteName}/js/lib/zTree/jquery.ztree.core.js' />"></script>
<script type="text/javascript" src="<c:url value='/${siteName}/js/lib/zTree/jquery.ztree.exedit.js' />"></script>
<script type="text/javascript" src="<c:url value='/${siteName}/js/lib/zTree/jquery.ztree.exhide.js' />"></script>
<script type="text/javascript" src="<c:url value='/${siteName}/js/lib/zTree/fuzzysearch.js' />"></script>
...
<script>
		...
		$.ajax({
	        ...
	        success : function(data) {
	        	...
	        	for  ( var i in data )  {
					...
					if  ( data[i].useAt == "0" )  {
						node.icon = "<c:url value='/${siteName}/js/lib/zTree/img/ztree_close.ico'/>";
					}
	...
	function fn_addPopupOpen(upperMenuCode, menuCode) {
	    $("#DIV_ADD").load("<c:url value='/system/menu/addPopup.do?upperMenuCode="+ upperMenuCode +"&menuCode="+ menuCode +"'/>",
