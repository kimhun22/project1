...
<%@include file="/WEB-INF/jsp/common/_inc/_default.jsp" %>
	...
	<h3 class="subTitle01">상세코드정보 <span>권한 정보는 수정이 불가 합니다. </span> </h3>
	<div class="">
	...
	<div class="btn_area a_right">
        <!-- <input type="button" class="button buttonM bGray" onclick="fn_addPopupOpen('${data.parntsCmmnCode}', '${data.cmmnCode}');" value="${data.cmmnCodeNm} 코드 추가 "/> -->
		<button type="button" class="ubtn gray03 hover" onclick="fn_addPopupOpen('${data.parntsCmmnCode}', '${data.cmmnCode}');"><i class="icon icon_addOnly"></i>${data.cmmnCodeNm} 코드 추가</button>
