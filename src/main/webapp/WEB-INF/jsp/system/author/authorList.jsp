...
<link rel="stylesheet" href="/${hmSiteCode}/js/lib/zTree/zTreeStyle.css" type="text/css">
<script type="text/javascript" src="/${hmSiteCode}/js/lib/zTree/jquery.ztree.core.js"></script>
<script type="text/javascript" src="/${hmSiteCode}/js/lib/zTree/jquery.ztree.exedit.js"></script>
<script type="text/javascript" src="/${hmSiteCode}/js/lib/zTree/jquery.ztree.exhide.js"></script>
<script type="text/javascript" src="/${hmSiteCode}/js/lib/zTree/fuzzysearch.js"></script>
...
<script>
    ...
    function fn_treeNodeSetting(selectedNode) {
        ...
        $.ajax({
            url : "/${hmSiteCode}<c:url value='/system/author/getListAjax.do'/>",
            data: {
            	cmmnCode: "COM001"
            },
    ...
    function fn_view(parntsCmmnCode, cmmnCode) {
        $.ajax({
            url : "/${hmSiteCode}<c:url value='/system/author/authorView.do'/>",
            data : {
        ...
        <div class="tab_content" style="overflow: hidden;">
            <div class="left_div" style="width: 40%;">
                <div class="div_sub_area">
                    <div class="">
                        <h3 class="subTitle01">역할 정보</h3>
                    </div>
                    <div class=" mgb_8">
                        <input type="text" class="mgr_4 md_w_full" id="Search" name="Search" placeholder="역할명을 입력하세요.">
